...
const ForYouScreen = () => {
  ...
  // Fix react-hooks/exhaustive-deps : on désactive intentionnellement
  // car on veut charger une seule fois au montage
  ...
  return (
    <View style={styles.container}>
      <View style={styles.searchBar}>
        ...
        />
        {inputValue.length > 0 && (
          // Fix no-inline-styles ligne 101
...
const styles = StyleSheet.create({
  ...
  // Fix no-inline-styles ligne 101
  clearBtn: { color: '#888', fontSize: 18, marginRight: 6 },
  searchBtn: {
  ...
  // Fix no-inline-styles ligne 57
  thumbnailIcon: { color: '#444', fontSize: 32 },
  cardInfo: { padding: 8 },
  ...
  // Fix no-inline-styles ligne 20
  authorAvatarLetter: { color: '#FFF', fontSize: 9, fontWeight: '700' },
